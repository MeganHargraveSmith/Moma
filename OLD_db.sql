...
CREATE TABLE Projects (
    ...
    clientId INTEGER,
    name TEXT NOT NULL,
    status TEXT DEFAULT 'not_started', -- Can be not_started, in_progress, awaiting_approval, done.
    deadline DATE,
    FOREIGN KEY (userId) REFERENCES Users (id) ON DELETE CASCADE,
    FOREIGN KEY (clientId) REFERENCES Clients (id) ON DELETE SET NULL
);

-- Stores subtasks of projects, so they can each be individually ticked off as the project progresses.
CREATE TABLE SubTasks (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    projectId INTEGER NOT NULL,
    name TEXT NOT NULL,
    status TEXT DEFAULT 'not_started', -- Can be not_started, in_progress, or done.
