    ...
    toast.innerHTML = `
        <div class="d-flex">
            <div class="toast-body">
                ${message}  // Inserts the message into the toast body.
            </div>
            <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>  // Adds a close button for the toast.
        </div>
    `;
